...
@app.route("/")
def home():
    return render_template('index.html', subject="안녕하세요. 반갑습니다. 박세훈입니다")
...
@app.route("/about")
def about():
    return render_template('korea.html', subject="출산율")
...
def kma1():
    # urlopen() 함수로 기상청의 전국 날씨를 읽습니다.
  target = request.urlopen("http://www.kma.go.kr/weather/forecast/mid-term-rss3.jsp?stnId=143")
